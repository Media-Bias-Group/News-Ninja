...
public class swipeLogic : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    private Vector2 lastMousePosition;
    private Vector3 ip;
    private static swipeLogic instance;
    public static swipeLogic Instance
    {
        get
        {
            return instance;
    ...
    {
        if (!QuestionsManager.Instance.annotationBtnTapped && guiManager.Instance.gameMode != guiManager.GameMode.quickWordMode)
        {
